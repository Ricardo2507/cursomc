...
public class ImageService {
	...
	/*
	 * //Corta a imagem para fazer um quadrado public BufferedImage
	 * cropImageEmQuadro(BufferedImage image) { //Pega o menor tamanho da imagem int
	 * minimo = (image.getWidth() <= image.getHeight()) ? image.getWidth() :
	 * image.getHeight();
	 * 
	 * //Realiza o crop da imagem return Scalr.crop(image, (image.getWidth()/2 -
	 * (minimo/2)), (image.getHeight()/2 - (minimo/2)), minimo, minimo); }
	 * 
	 * 
	 * //muda o tamanho da imagem public BufferedImage resize(BufferedImage image,
	 * int tamanho) { return Scalr.resize(image, Scalr.Method.ULTRA_QUALITY,
	 * tamanho); }
	 */
