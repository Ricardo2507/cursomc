...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Categoria cat9 = new Categoria(null, "Teste1");
		...
		Produto p7 = new Produto(null, "TV tru color", 1200.00);
		Produto p8 = new Produto(null, "Roçadeira", 800.00);
		Produto p9 = new Produto(null, "Abajour", 100.00);
		Produto p10 = new Produto(null, "Pendente", 180.00);
		Produto p11 = new Produto(null, "Shappom", 800.00);
		...
		cidadeRepository.saveAll(Arrays.asList(c1, c2, c3));
		  ...
		  Cliente cli1 = new Cliente(null, "Maria Silva", "rscarvalho@hotmail.com",
		  "36378912377", TipoCliente.PESSOAFISICA, bpe.encode("12345"));
		  cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		  
		  Cliente cli2 = new Cliente(null, "Ana Costa", "rscarvalholiveira@gmailmail.com",
				  "36378912377", TipoCliente.PESSOAFISICA, bpe.encode("12345"));
		  ...
		  Endereco e3 = new Endereco (null, "Av. Fudustreco", "50", "Apto 555", "Centro", "5000000", cli2, c2);
